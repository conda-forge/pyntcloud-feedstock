...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyntcloud-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8045&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyntcloud-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyntcloud` can be installed with:

```
conda install pyntcloud
```

It is possible to list all of the versions of `pyntcloud` available on your platform with:
